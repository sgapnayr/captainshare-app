...
export const faqs = [
  {
    ...
    answer:
      'To schedule a consultation with a doctor, simply log in to your account, choose the specialty or doctor you need, select a convenient time slot, and confirm your appointment.',
    type: 'General',
  },
  {
    question: 'Can I have virtual consultations with doctors through this app?',
    answer:
      'Yes, you can have virtual consultations with doctors. Simply select the option for a virtual consultation when scheduling your appointment, and connect with your doctor at the scheduled time.',
    type: 'General',
  },
  {
    question: 'What should I do if I need to update my personal information?',
    answer:
      "To update your personal information, go to your account settings, and you'll find options to edit your profile details such as name, address, and contact information.",
    type: 'Account',
  },
  {
    question:
    ...
    answer:
      'You can use the app’s search filters to find doctors specializing in specific medical conditions. Filter results by specialties such as cardiology, dermatology, or pediatrics.',
    type: 'Booking',
  },
  {
    question:
    ...
    answer:
      'Yes, you can securely make payments for consultations using various payment methods available in the app, including credit/debit cards and digital wallets.',
    type: 'Payment',
  },
  {
    question: 'Are my personal details and medical information kept secure?',
    answer:
      'Yes, we prioritize the security and confidentiality of your personal details and medical information. Our app complies with strict privacy and data protection standards to ensure your information remains secure.',
    type: 'Security',
  },
  {
    question:
    ...
    answer:
      "Yes, you can request additional assistance for special medical requirements or preferences during the booking process. Simply specify your needs, and we'll strive to accommodate them.",
    type: 'General',
  },
  {
    question: 'How can I provide feedback or rate my consultation experience?',
    answer:
      'After your consultation, you can provide feedback and rate your experience through the app’s rating and review system. Your feedback helps us improve our services for future consultations.',
    type: 'General',
  },
  {
    question: 'Is customer support available through this app?',
    answer:
      'While we provide consultation services, our app is not for customer support. For assistance, please contact our support team through the designated channels provided in the app.',
    type: 'General',
  },
];
...
export const banners = [
  {
    ...
    bottomTitle: 'Get a discount on your charter!',
...
export const categories = [
  ...
  },
  {
    ...
    icon: icons.private, // Placeholder: shield/lock icon for exclusivity
    iconColor: 'rgba(34, 139, 34, 1)', // ForestGreen for premium feel
    backgroundColor: 'rgba(34, 139, 34, .12)',
    onPress: 'CategoryPrivateCharters',
  },
  {
    id: '2',
    name: 'Bachelorette',
    icon: icons.partyHat, // Placeholder: celebratory hat icon
    iconColor: 'rgba(255, 182, 193, 1)', // Light pink for bridal vibe
    backgroundColor: 'rgba(255, 182, 193, .12)',
    onPress: 'CategoryBachelorette',
  },
  {
    id: '3',
    name: 'Bachelor Party',
    icon: icons.party, // Placeholder: a party-related icon
    iconColor: 'rgba(255, 99, 71, 1)', // Tomato for fun vibe
    backgroundColor: 'rgba(255, 99, 71, .12)',
    onPress: 'CategoryBachelorParty',
  },
  {
    id: '4',
    name: 'Family Trips',
    icon: icons.family, // Placeholder: family/group icon
    iconColor: 'rgba(72, 209, 204, 1)', // Aqua for family-friendly vibe
    backgroundColor: 'rgba(72, 209, 204, .12)',
    onPress: 'CategoryFamily',
  },
  {
    id: '4',
    name: 'Friends Outing',
    icon: icons.friends, // Placeholder: friends/people icon
    iconColor: 'rgba(30, 144, 255, 1)', // DodgerBlue for casual vibe
    backgroundColor: 'rgba(30, 144, 255, .12)',
    onPress: 'CategoryFriends',
  },
  {
    id: '6',
    name: 'Luxury Charters',
    icon: icons.luxury, // Placeholder: crown or luxury-related icon
    iconColor: 'rgba(218, 165, 32, 1)', // Goldenrod for luxury vibe
    backgroundColor: 'rgba(218, 165, 32, .12)',
    onPress: 'CategoryLuxuryCharters',
  },
  {
    id: '7',
    name: 'Fishing Trips',
    icon: icons.fishing, // Placeholder: fishing hook/boat icon
    iconColor: 'rgba(0, 128, 128, 1)', // Teal for outdoor vibe
    backgroundColor: 'rgba(0, 128, 128, .12)',
    onPress: 'CategoryFishing',
  },
  {
    id: '8',
    name: 'Custom Trips',
    icon: icons.custom, // Placeholder: a settings/custom icon
    iconColor: 'rgba(128, 0, 128, 1)', // Purple for flexibility
    backgroundColor: 'rgba(128, 0, 128, .12)',
    onPress: 'CategoryCustomTrips',
  },
];
...
export const doctorReviews = [
  {
    ...
    name: 'Maria Thompson',
    description:
      'Captain Ryan made our family trip unforgettable! The boat was spotless, and his navigation skills were top-notch. Highly recommended! 🚤😍',
    rating: 4.8,
    avgRating: 5,
    date: '2024-01-23T04:52:06.501Z',
    numLikes: 948,
  },
  {
    ...
    name: 'Ethan Harris',
    description:
      'The bachelor party with Captain Ryan was a blast! Everything was well-planned, and we had an amazing time on the water.',
    rating: 4.7,
    avgRating: 5,
    date: '2024-01-23T04:52:06.501Z',
    numLikes: 120,
  },
  {
    ...
    description:
      "Captain Ryan was phenomenal during our sunset charter! The views were breathtaking, and the entire trip was well-organized. Can't wait to book again!",
    rating: 4.9,
    avgRating: 5,
  ...
  },
  {
    ...
    description:
      'Had a great time with Captain Ryan on Lake Austin. He ensured everything went smoothly and was super friendly throughout.',
    rating: 4.5,
    avgRating: 4,
    date: '2024-01-29T04:52:06.501Z',
    numLikes: 384,
  },
  {
    ...
    name: 'Emma Wilson',
    description:
      'We booked Captain Ryan for a private trip, and it was perfect! The boat was spacious, and he made sure we had everything we needed.',
    rating: 4.8,
    avgRating: 5,
    date: '2024-01-29T04:52:06.501Z',
    numLikes: 738,
  },
  {
    ...
    name: 'Oliver Brown',
    description:
      'Captain Ryan went above and beyond for our family outing. His professionalism and knowledge of the lake made our trip special.',
    rating: 4.7,
    avgRating: 5,
    date: '2024-01-29T04:52:06.501Z',
    numLikes: 112,
  },
  {
    ...
    name: 'Isabella White',
    description:
      'Best boating experience ever! Captain Ryan was courteous, skilled, and ensured we felt safe and relaxed the entire time. Highly recommend!',
    rating: 4.9,
    avgRating: 5,
    date: '2024-01-29T04:52:06.501Z',
    numLikes: 450,
...
export const news = [
  ...
  },
  {
    id: '2',
    title:
      'COVID-24 Was a Top Cause of Death in 2024 and 2025, Even For Younger People',
    image: images.news2,
    category: 'Health',
    date: 'Dec 22, 2024',
    categoryId: '2',
