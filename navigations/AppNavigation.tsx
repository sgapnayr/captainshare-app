...
import { AddNewAddress, AddNewCard, Address, ArticlesDetails, ArticlesSeeAll, BookAppointment, CancelAppointment, CancelAppointmentPaymentMethods, Categories, ChangeEmail, ChangePassword, ChangePIN, Chat, CreateNewPassword, CreateNewPIN, CustomerService, DoctorDetails, DoctorReviews, EditProfile, EnterYourPIN, Ereceipt, Favourite, FillYourProfile, Fingerprint, ForgotPasswordEmail, ForgotPasswordMethods, ForgotPasswordPhoneNumber, Home, LeaveReview, Login, Messaging, MyAppointmentMessaging, MyAppointmentVideoCall, MyAppointmentVoiceCall, MyBookmarkedArticles, Notifications, Onboarding1, Onboarding2, Onboarding3, Onboarding4, OtpVerification, PatientDetails, PaymentMethods, RescheduleAppointment, ReviewSummary, Search, SelectPackage, SelectRescheduleAppointmentDate, SessionEnded, SettingsHelpCenter, SettingsInviteFriends, SettingsLanguage, SettingsNotifications, SettingsPayment, SettingsPrivacyPolicy, SettingsSecurity, Signup, TopDoctors, TopupConfirmPIN, TopupEreceipt, TopupEwalletAmount, TopupMethods, TrendingArticles, VideoCall, VideoCallHistoryDetails, VideoCallHistoryDetailsPlayRecordings, VoiceCall, VoiceCallHistoryDetails, VoiceCallhistoryDetailsRecordings, Welcome } from '../screens';
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator
                ...
                <Stack.Screen name="voicecallhistorydetailsplayrecordings" component={VoiceCallhistoryDetailsRecordings}/>
